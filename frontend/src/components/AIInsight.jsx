...
export default function AIInsight({ weakTopics = [], strongTopics = [], summary, roadmap }) {
  ...
  return (
    <section className="adaptive-panel relative overflow-hidden rounded-3xl p-6 shadow-xl shadow-ink/10 sm:p-8">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          {focus && (
            <div className="rounded-2xl adaptive-subpanel p-4">
