...
export const SUBJECT_QUIZ_BANK = {
  ...
  "Mechanical Engineering": [
    { question: "The centroid of a uniform rectangular plate lies at:", topic: "Engineering Mechanics", difficulty: "easy", options: ["One corner", "The geometric center", "The midpoint of one edge", "Any arbitrary point"], correctAnswer: "The geometric center" },
    { question: "The SI unit of stress is:", topic: "Strength of Materials", difficulty: "easy", options: ["Newton", "Pascal", "Joule", "Watt"], correctAnswer: "Pascal" },
    { question: "For an ideal gas, the equation of state is:", topic: "Thermodynamics", difficulty: "medium", options: ["PV = nRT", "PV = RT/n", "P + V = nRT", "P/V = nRT"], correctAnswer: "PV = nRT" },
    { question: "In a frictionless four-stroke engine, one complete cycle requires:", topic: "Dynamics of Machines", difficulty: "medium", options: ["One crank revolution", "Two crank revolutions", "Three crank revolutions", "Four crank revolutions"], correctAnswer: "Two crank revolutions" },
    { question: "For steady one-dimensional conduction through a plane wall, heat flux is proportional to:", topic: "Heat Transfer", difficulty: "hard", options: ["Temperature gradient", "Absolute temperature only", "Wall volume", "Pressure only"], correctAnswer: "Temperature gradient" },
    { question: "A ductile material under a purely hydrostatic stress state primarily experiences:", topic: "Strength of Materials", difficulty: "hard", options: ["Shear distortion", "Volumetric deformation", "No deformation", "Buckling"], correctAnswer: "Volumetric deformation" },
  ],
  "Electrical Engineering": [
    { question: "The SI unit of electrical resistance is:", topic: "Circuit Analysis", difficulty: "easy", options: ["Volt", "Ohm", "Ampere", "Watt"], correctAnswer: "Ohm" },
    { question: "Kirchhoff's current law is based on conservation of:", topic: "Circuit Analysis", difficulty: "easy", options: ["Charge", "Energy", "Momentum", "Mass"], correctAnswer: "Charge" },
    { question: "In a purely inductive AC circuit, current lags voltage by:", topic: "Circuit Analysis", difficulty: "medium", options: ["0°", "45°", "90°", "180°"], correctAnswer: "90°" },
    { question: "A transformer operates on the principle of:", topic: "Electrical Machines", difficulty: "medium", options: ["Mutual induction", "Electrolysis", "Thermionic emission", "Photoelectric effect"], correctAnswer: "Mutual induction" },
    { question: "For a stable LTI continuous-time system, the impulse response must be:", topic: "Signals and Systems", difficulty: "hard", options: ["Absolutely integrable", "Periodic", "Constant", "Odd"], correctAnswer: "Absolutely integrable" },
    { question: "Maximum power is transferred to a resistive load when the load resistance equals:", topic: "Circuit Analysis", difficulty: "hard", options: ["Zero", "The source resistance", "Twice the source resistance", "Infinity"], correctAnswer: "The source resistance" },
  ],
  "Electronics & Communication Engineering": [
    { question: "A diode primarily allows current to flow:", topic: "Electronic Devices", difficulty: "easy", options: ["Equally in both directions", "Predominantly in one direction", "Only at zero voltage", "Only in AC circuits"], correctAnswer: "Predominantly in one direction" },
    { question: "A logic gate that outputs 1 only when all inputs are 1 is:", topic: "Digital Electronics", difficulty: "easy", options: ["OR", "AND", "XOR", "NOR"], correctAnswer: "AND" },
    { question: "In the active region of a BJT, the base-emitter and collector-base junctions are:", topic: "Electronic Devices", difficulty: "medium", options: ["Forward, reverse", "Reverse, forward", "Both forward", "Both reverse"], correctAnswer: "Forward, reverse" },
    { question: "According to the sampling theorem, the sampling frequency must be greater than twice the:", topic: "Signals and Systems", difficulty: "medium", options: ["Bandwidth only", "Highest frequency component", "Carrier amplitude", "Phase angle"], correctAnswer: "Highest frequency component" },
    { question: "A common-emitter amplifier primarily provides:", topic: "Analog Electronics", difficulty: "hard", options: ["Voltage gain", "Only current isolation", "No amplification", "Only rectification"], correctAnswer: "Voltage gain" },
    { question: "The Nyquist rate for a band-limited signal with highest frequency 20 kHz is:", topic: "Signals and Systems", difficulty: "hard", options: ["10 kHz", "20 kHz", "40 kHz", "80 kHz"], correctAnswer: "40 kHz" },
  ],
};

export function getSubjectQuiz(subject, count = 6) {
