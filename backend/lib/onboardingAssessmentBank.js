...
const UG_CORE_BANK = [
  ...
  q("Chemistry", "Chemical Bonding", "easy", "According to molecular orbital theory, O₂ is paramagnetic because it contains:", ["Two unpaired electrons", "No unpaired electrons", "A zero bond order", "Only bonding electrons"], "Two unpaired electrons"),
  q("Chemistry", "Oxidation and Reduction", "medium", "In a redox reaction, the species that gains electrons is undergoing:", ["Oxidation", "Reduction", "Neutralisation", "Hydrolysis"], "Reduction"),
  q("Chemistry", "Chemical Bonding", "easy", "Which principle states that electrons occupy degenerate orbitals singly before pairing, with parallel spins?", ["Hund's rule", "Pauli exclusion principle", "Le Chatelier's principle", "Aufbau principle"], "Hund's rule"),

  q("Biology", "Life Processes", "easy", "Which enzyme converts angiotensin I to angiotensin II?", ["Renin", "ACE", "Pepsin", "Trypsin"], "ACE"),
  q("Biology", "Heredity and Evolution", "medium", "A heterozygous autosomal dominant individual is crossed with an unaffected individual. Expected probability of an affected child is:", ["0%", "25%", "50%", "100%"], "50%"),
  q("Biology", "Control and Coordination", "hard", "Which cell type forms myelin around axons in the central nervous system?", ["Schwann cells", "Oligodendrocytes", "Astrocytes", "Microglia"], "Oligodendrocytes"),
...
const BRANCH_BANKS = {
  "Computer Science": [
    q("Computer Science", "Algorithms", "easy", "Which data structure is most directly associated with breadth-first search?", ["Stack", "Queue", "Heap", "Hash table"], "Queue"),
  ...
  "Mechanical Engineering": [
    ...
    q("Mechanical Engineering", "Engineering Mathematics", "easy", "The derivative of x² with respect to x is:", ["x", "2x", "x²", "2"], "2x"),
  ...
  "Electrical Engineering": [
    ...
    q("Electrical Engineering", "Engineering Mathematics", "easy", "The derivative of sin x is:", ["cos x", "-cos x", "sin x", "-sin x"], "cos x"),
  ...
  "Electronics & Communication Engineering": [
    ...
    q("Electronics & Communication Engineering", "Engineering Mathematics", "easy", "The derivative of eˣ is:", ["eˣ", "xeˣ", "1/eˣ", "ln x"], "eˣ"),
